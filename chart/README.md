...
| fluentd.aggregator.extraVolumes[0].name                 | Fluentd aggregator extra volumes                                                             | nil                                            |
| fluentd.aggregator.extraVolumes[0].persistentVolumeClaim.claimName | Fluentd aggregator extra volumes persistent volume claim name | nil                                            |
| iq_server.image | Nexus IQ Server image                                                                        | sonatype/nexus-iq-server                       |
| iq_server.tag | Nexus IQ Server image tag                                                                    | 1.103.0-01                                     |
