...
| `iq_server.tag`                                           | Nexus IQ Server image tag                                                                     | See value in `values.yaml`                                  |
...
| `iq_server.config.licenseFile`                            | License file                                                                                  | `nil`                                                       |
...
| `iq_server.config.server.requestLog`                      | Nexus IQ Server request log                                                                   | See `values.yaml` for suggested minimum recommended values. |
...
| `ingress-nginx.controller`                                | Ingress-nginx controller configuration                                                        | See `values.yaml` for suggested minimum recommended values. |
...
| `fluentd.config`                                          | Fluentd configuration                                                                         | See `values.yaml`for suggested minimum recommended values.  |
