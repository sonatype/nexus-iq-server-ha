...
|------------------------------------------------------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| `iq_server.license`                                        | Path to your Nexus IQ Server product license file                                             | `""`                                                        |
| `iq_server.licenseSecret`                                  | License secret                                                                                | `""`                                                        |
| `iq_server.image`                                          | Nexus IQ Server image                                                                         | `sonatype/nexus-iq-server`                                  |
| `iq_server.tag`                                            | Nexus IQ Server image tag                                                                     | `1.151.0`                                                   |
...
| `iq_server.database.username`                              | Database username                                                                             | `nil`                                                       |
...
| `iq_server.initialAdminPassword`                           | Initial admin password                                                                        | `nil`                                                       |
| `iq_server.initialAdminPasswordSecret`                     | Initial admin password secret                                                                 | `nil`                                                       |
| `iq_server.persistence.size`                               | Size of the persistent volume claim                                                           | `1Gi`                                                       |
| `iq_server.persistence.accessModes[0]`                     | Access modes for the persistent volume claim                                                  | `ReadWriteOnce`                                             |
| `iq_server.persistence.storageClassName`                   | Storage class name for the persistent volume claim                                            | `""`                                                        |
| `iq_server.persistence.csi.driver`                         | CSI driver name for the persistent volume claim                                               | `efs.csi.aws.com`                                           |
| `iq_server.persistence.csi.fsType`                         | File system type for the persistent volume claim                                              | `""`                                                        |
| `iq_server.persistence.csi.volumeHandle`                   | Volume handle for the persistent volume claim                                                 | `nil`                                                       |
| `iq_server.persistence.csi.volumeAttributes`               | Volume attributes for the persistent volume claim                                             | `nil`                                                       |
| `iq_server.persistence.nfs.server`                         | NFS server hostname                                                                           | `nil`                                                       |
| `iq_server.persistence.nfs.path`                           | NFS server path                                                                               | `nil`                                                       |
| `iq_server.persistence.hostPath.path`                      | Host path                                                                                     | `nil`                                                       |
...
| `iq_server.config.sonatypeWork`                            | Sonatype work directory                                                                       | `/sonatype-work/clm-server`                                 |
| `iq_server.config.clusterDirectory`                        | Cluster directory                                                                             | `/sonatype-work/clm-server/cluster`                         |
| `iq_server.config.database`                                | Database configuration                                                                        | See `values.yaml` for suggested minimum recommended values. |
| `iq_server.config.server.hostApplication`                  | Nexus IQ Server application host                                                              | `nil`                                                       |
| `iq_server.config.server.hostAdmin`                        | Nexus IQ Server admin host                                                                    | `nil`                                                       |
| `iq_server.config.server.applicationContextPath`           | Nexus IQ Server application context path                                                      | `/`                                                         |
| `iq_server.config.server.adminContextPath`                 | Nexus IQ Server admin context path                                                            | `/`                                                         |
| `iq_server.config.server.applicationConnectors.type`       | Nexus IQ Server application connectors type                                                   | `http`                                                      |
| `iq_server.config.server.applicationConnectors.port`       | Nexus IQ Server application connectors port                                                   | `8070`                                                      |
| `iq_server.config.server.adminConnectors.type`             | Nexus IQ Server admin connectors type                                                         | `http`                                                      |
| `iq_server.config.server.adminConnectors.port`             | Nexus IQ Server admin connectors port                                                         | `8071`                                                      |
| `iq_server.config.logging`                                 | Logging configuration                                                                         | See `values.yaml` for suggested minimum recommended values. |
| `iq_server.config.createSampleData`                        | Create sample data                                                                            | `true`                                                      |
| `secret.license.arn`                                       | AWS secret arn containing lifecycle license                                                   | `nil`                                                       |
| `secret.rds.arn`                                           | AWS secret arn containing host, port, name (database name), username, and password properties | `nil`                                                       |
| `secret.arn`                                               | AWS secret arn containing initial admin password                                              | `nil`                                                       |
| `postgresql.enabled`                                       | Enable PostgreSQL                                                                             | `false`                                                     |
| `postgresql.fullnameOverride`                              | PostgreSQL fullname                                                                           | `postgresql`                                                |
| `postgresql.persistence.existingPersistentVolumeName`      | PostgreSQL existing persistent volume name                                                    | `nil`                                                       |
| `postgresql.persistence.existingPersistentVolumeClaimName` | PostgreSQL existing persistent volume claim name                                              | `nil`                                                       |
| `postgresql.persistence.persistentVolumeName`              | PostgreSQL persistent volume name                                                             | `postgres-pv`                                               |
| `postgresql.persistence.persistentVolumeClaimName`         | PostgreSQL persistent volume claim name                                                       | `postgres-pvc`                                              |
| `postgresql.persistence.persistentVolumeRetainPolicy`      | PostgreSQL persistent volume retain policy                                                    | `keep`                                                      |
| `postgresql.persistence.persistentVolumeClaimRetainPolicy` | PostgreSQL persistent volume claim retain policy                                              | `keep`                                                      |
| `postgresql.persistence.size`                              | PostgreSQL persistent volume size                                                             | `1Gi`                                                       |
| `postgresql.persistence.storageClassName`                  | PostgreSQL persistent volume storage class name                                               | `""`                                                        |
| `postgresql.persistence.accessModes[0]`                    | PostgreSQL persistent volume access modes                                                     | `ReadWriteOnce`                                             |
| `postgresql.persistence.csi.driver`                        | PostgreSQL persistent volume CSI driver                                                       | `efs.csi.aws.com`                                           |
| `postgresql.persistence.csi.fsType`                        | PostgreSQL persistent volume file system type                                                 | `""`                                                        |
| `postgresql.persistence.csi.volumeHandle`                  | PostgreSQL persistent volume volume handle                                                    | `nil`                                                       |
| `postgresql.persistence.nfs.server`                        | PostgreSQL persistent volume NFS server                                                       | `nil`                                                       |
| `postgresql.persistence.nfs.path`                          | PostgreSQL persistent volume NFS path                                                         | `"/"`                                                       |
| `postgresql.persistence.hostPath.path`                     | PostgreSQL persistent volume host path                                                        | `/mnt/postgres`                                             |
| `postgresql.persistence.hostPath.type`                     | PostgreSQL persistent volume host path type                                                   | `DirectoryOrCreate`                                         |
| `postgresql.persistence.auth.database`                     | PostgreSQL database name                                                                      | `iq-server`                                                 |
| `postgresql.persistence.auth.postgresPassword`             | PostgreSQL password                                                                           | `admin123`                                                  |
| `postgresql.persistence.primary.persistence.existingClain` | PostgreSQL primary existing persistent volume claim name                                      | `postgres-pvc`                                              |
...
| `ingress`                                                  | Ingress configuration                                                                         | See `values.yaml`for suggested minimum recommended values.  |
| `fluentd`                                                  | Fluentd configuration                                                                         | See `values.yaml`for suggested minimum recommended values.  |
| `ingress-nginx`                                            | Ingress-nginx configuration                                                                   | See `values.yaml`for suggested minimum recommended values.  |
