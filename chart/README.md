...
| `ingress.hostApplicationPath`                              | Ingress host for application path                                                             | `iq_server.config.server.applicationContextPath`            |
| `ingress.hostAdminPath`                                    | Ingress host for admin path                                                                   | `iq_server.config.server.adminContextPath`                  |
...
| `ingress.tls[0].certificate`                               | Ingress TLS certificate                                                                       | `nil`                                                       |
| `ingress.tls[0].key`                                       | Ingress TLS key                                                                               | `nil`                                                       |
| `ingress.tls[0].secretName`                                | Ingress TLS secret name                                                                       | `nil`                                                       |
| `ingress.tls[0].hosts[0]`                                  | Ingress TLS hosts                                                                             | `nil`                                                       |
